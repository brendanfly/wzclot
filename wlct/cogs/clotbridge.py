...
class CLOTBridge:
    ...
    @database_sync_to_async
    def getGameLogGamesSliced(self, num):
        return list(TournamentGame.objects.filter(is_finished=True, game_log_sent=False).select_related('tournament', 'winning_team')[:num])
